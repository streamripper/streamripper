...
error_code cbuf2_ogg_peek_song(
    CBUF2 *cbuf2,
    char *out_buf,
...
error_code cbuf2_extract_relay(
    CBUF2 *cbuf2, char *data, u_long *pos, u_long *len, int icy_metadata);
#endif
